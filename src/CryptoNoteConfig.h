...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX = 0x619a831a6e1; /* emadcash address prefix */
...
const uint64_t MONEY_SUPPLY = UINT64_C(3141592653000000); /* max supply: 3.14B */
...
const uint64_t MINIMUM_FEE = UINT64_C(1000); /* 0.001000 madcash */
const uint64_t MINIMUM_FEE_BANKING = UINT64_C(1000); /* 0.001000 madcash */
const uint64_t DEFAULT_DUST_THRESHOLD = UINT64_C(10); /* 0.000010 madcash */  
...
const uint64_t START_BLOCK_REWARD 							  = (UINT64_C(314159265000000) * parameters::COIN); // start reward
const uint64_t FOUNDATION_TRUST 							  = (UINT64_C(314159265) * parameters::COIN); // 314M locked funds to secure network
const uint64_t MAX_BLOCK_REWARD 							  = (UINT64_C(10) * parameters::COIN); // max reward after aprox. 20 months
const uint64_t REWARD_INCREASE_INTERVAL 					  = (UINT64_C(22000)); // aprox. 1 month (+ 0.25 madcash increment per month)

const char     CRYPTONOTE_NAME[] 							  = "MarchMadCash";
const char     GENESIS_COINBASE_TX_HEX[] 					  = "010a01ff000180ade204029b2e4c0281c0b02e7c53291a94d1d0cbff8883f8024f5142ee494ffbbd0880712101863057ece3b1700c378ba000b7110a74779a92a5deab394eac253381dcd479bc";
...
const std::initializer_list<const char*> SEED_NODES  = {
   "34.219.141.170:31400", //seed1
   "13.56.59.247:31400"   // seed2
